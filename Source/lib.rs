	...
	A: Into<OsString> + Clone,
{
	...
	let args::Args { skip, rc, manager, project_name, template, force, identifier } = args;
	...
	// Render the template
	template.render(&target_dir, pkg_manager, &project_name, &package_name, &identifier, rc)?;
